  ...
  argonDashBody(
    ...
    argonTabItems(
      argonTabItem(
        ...
        # titles
        argonRow(
          argonColumn(width = 6, uiOutput("admin_upload_data_title")),
          argonColumn(width = 6, uiOutput("admin_files_title"))
        ),
        argonRow(
          argonColumn(width = 4, uiOutput("admin_upload_data_select")),
          argonColumn(width = 4, uiOutput("admin_files_list")),
          argonColumn(
            width = 4,
